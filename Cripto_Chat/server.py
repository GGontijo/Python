              ...
              \ \ \/_/\    \   ___   \ \    \   __  \ \      \  \ \          
               \ \_\ \ \    \  \ \ \  \ \    \  \ \  \ \      \  \ \         
                \_____\/     \__\/  \__\/     \__\/\__\/       \__\/              
                   ...
                   | cripto_chat \033[91mserver-side\033[0m v1.3 | by \033[91mDercilio\033[0m |
	                                                                                                                      
"""

def sigint_handler(signum, frame):
    print '\n user interrupt ! shutting down'
    print "[NOTICE] Server shutting down... \n\n"
    sys.exit()	
...
def chat_server():
    ...
    print "Starting sever on port: " + str(PORT)

    if VIEW == '1':
	    print ''
	    print "[NOTICE] Transparency mode is on, you will be able to see all the messages passing through the sever!"
	    print "To change this, please set the VIEW to 0 in the configuration file"
